...
- We are going to find "Word Twins", which are pairs of English words, at least 4 letters long, where the first three letters of one are the last three letters of another.  For example, "strategy" and "Egypt".
